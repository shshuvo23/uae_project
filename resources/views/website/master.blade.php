...
<body class="body-bg">
            ...
            <div class="nav-sec padding-b-50">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="index.html"><img src="{{asset('/')}}website/assets/img/logo/logo.png" alt="logo"></a>
    ...
    <section id="home" class="bx-home home-section bx-section padding-tb-80 bg-shape-hero">
        ...
        <img id="shape3" class="parallax left top" src="{{asset('/')}}website/assets/img/bg/shape-3.png" alt="shape">
        <img id="shape4" class="parallax left" src="{{asset('/')}}website/assets/img/bg/shape-4.png" alt="shape">
        <img id="shape5" class="parallax bottom" src="{{asset('/')}}website/assets/img/bg/shape-5.png" alt="shape">
                    ...
                    <div class="basic-details" data-aos="fade-up" data-aos-duration="2000">
                        <div class="info">
                            ...
                            <p>At Copy Crafter, we wield the art of language to craft compelling narratives,
                                 captivate audiences, and transform brands. With a passion for storytelling and an unwavering commitment to excellence, we're more than just copywriters; we're your partners in communication.</p>
                            {{-- <div class="buttons">
        ...
        <div class="container">
                        ...
                        <div class="card-description">
                            ...
                            <div class="detailed-txt">
                                ...
                                <p> Our words have the power to evoke emotions,
                                     spark curiosity, and ignite action. From the first sentence to the last, every word is carefully chosen to leave a lasting impression.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-description">
                            ...
                            <div class="detailed-txt">
                                ...
                                <p>Elevate your brand's identity with copy that resonates.
                                     Whether you're a startup on the rise or an established business seeking a fresh voice, we tailor our approach to align with your goals.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="section-card" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
                        ...
                        <div class="card-description">
                            ...
                            <div class="detailed-txt">
                                ...
                                <p>It's not just about what we write, it's about how your audience connects. We delve into your brand's DNA to deliver messages that forge genuine connections.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                        ...
                        <div class="card-description">
                            ...
                            <div class="detailed-txt">
                                ...
                                <p> 
                                    ...
                                    it's about strategy. 
                                    We infuse data-driven insights to ensure your message reaches the right people at the right time.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border-bottom" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
                    <div class="title" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
                        <p class="p-text">Ready to tell your brand's story? Let's embark on a journey of words that captivate,
                             compel, and convert. Together, we'll create narratives that resonate, inspire, and leave a lasting imprint on your audience's minds.
    ...
    <section id="experience" class="bx-experience-section bx-section padding-tb-80">
        <div class="container">
            ...
            <div class="row mb-m-30">
                <div class="title" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
                    <p class="light-txt">qualification</p>
                    <h2>My<span class="primary-clr"> achievements</span></h2>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-xs-12 mix design">
                                            <div class="hovereffect">
                                                ...
                                                <div class="overlay">
                                                    <div class="overlay-info">
                                                        <a class="info" href="#">Boros - Artificial Intelligence</a>
                                                        <a class="info" data-fancybox="gallery"
                                ...
                                <div class="item">
                                    <div class="card" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
                                        ...
                                        <div class="news-card-details">
                                            <p class="primary-clr">By Admin <span class="comments">- 04 Comments</span>
                                            </p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
                        <div class="border-box">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control border-none" id="subject" placeholder="Subject">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
